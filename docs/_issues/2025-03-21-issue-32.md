...
date: 2025-03-21
seo_title: "Snapp iOS Weekly Issue 32"
description: "This week we're looking at the internals of the virtual memory management in iOS, we experiment with using SwiftUI animations in UIKit, we set up Sign in…"
sections: [swift, ui-ux, visionos, data, misc]
---
