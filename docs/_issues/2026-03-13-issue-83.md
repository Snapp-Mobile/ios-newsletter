...
This week we're looking at using Swift for building command line tools, re-assessing the use of MVVM pattern with SwiftUI, refreshing our memory on `NSCache`, peak at wiring up analytics, using agentic skills for iOS development and more.
